...
③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.`,
  ...
  {
    num: "제4조",
    title: "이용자 및 법정대리인의 권리와 그 행사 방법",
...
4. 구속수용자 교육 신청(보호자가 대리 신청하는 경우)
필수항목 : 수용자의 성명, 생년월일, 수용번호, 수용시설명 및 주소, 신청자(보호자)의 연락처, 신청자와 수용자의 관계
이용목적 : 교육자료 우편 발송, 수료증 발급 및 발송
보유기간 : 서비스 제공 완료 후 「전자상거래 등에서의 소비자 보호에 관한 법률」에 따른 거래기록 보존기간(5년) 동안 보관 후 파기
※ 신청자는 수용자의 개인정보를 제공하기 전에 수용자 본인으로부터 필요한 동의를 받아야 합니다.`,
  },
  {
    num: "제6조",
    title: "개인정보의 파기",
...
성명 : 윤승진
직책 : 대표자
연락처 : admin@kcpec.co.kr
※ 개인정보 보호 담당부서로 연결됩니다.

▶ 개인정보 보호 담당부서
부서명 : 주식회사 한국범죄예방교육센터 관리자
담당자 : 윤승진
연락처 : admin@kcpec.co.kr
...
▶ 경찰청 사이버안전국 : 182 (http://cyberbureau.police.go.kr)`,
  ...
  {
    num: "제12조",
    title: "개인정보 처리방침 시행 및 변경",
    body: `이 개인정보 처리방침은 2024. 5. 1.부터 적용됩니다.`,
  },
];
