...
const DOCUMENTS: { name: string; desc: string; href: string; cta: string }[] = [
  {
    name: "강의 수료증",
    desc: "각 강의를 결제 후 수강을 완료하고 퀴즈를 모두 통과하면 발급되는 PDF 수료증입니다. 위변조 방지 워터마크와 발급번호가 포함되어 법원·수사기관 제출에 사용하실 수 있습니다.",
    href: "/courses",
    cta: "강의 전체보기",
  },
  {
    name: "심리상담 의견서",
    desc: "전문 심리상담사가 작성하는 법원 제출용 공식 문서입니다. 온라인 설문 기반 서면상담과 전화 심화상담(회당 15분 × 3회) 중 선택해 별도로 구매하실 수 있습니다.",
    href: "/counseling",
    cta: "전문가 심리상담 알아보기",
  },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      ...
      <Section title="서비스 소개">
        <p>
          한국범죄예방교육센터(KCPEC)는 형사 피의자·피고인 또는 일반인을 대상으로
          심리·준법교육 과정을 제공합니다. 강의를 결제하시면 바로 수강을 시작하실
          수 있으며, 수료(완강+퀴즈 통과)하시면 수료증이 즉시 발급됩니다. 전문가 심리상담
